...
class PengaduanUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.pengaduanUser.detail', compact('pengaduans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengaduanUser.create')->with('success', 'Pengaduan created successfully');
    }
    ...
    {
        $pengaduan = Pengaduan::findOrFail($id);
        return view('pages.pengaduanUser.edit', compact('pengaduan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengaduanUser.index')->with('success', 'Pengaduan updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $pengaduan->delete();
        return redirect()->route('pengaduanUser.index')->with('success', 'Pengaduan deleted successfully');
    }
}
